  ...
  <body>
    ...
    <form action="/update/traitement" method="post">
        ...
        <div class="form-group">
            ...
            <input type="date" class="form-control" id="date" name="date_de_creation" value="{{ $articles->date_de_creation }}">
        </div>
        <br>
        ...
        <div class="form-group">
            ...
            <input type="url" class="form-control" id="image" name="image" placeholder="Entrer l'url de votre image ici.." value="{{ $articles->image }}">
        </div>
        <br>
